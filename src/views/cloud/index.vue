...
<!--                    </el-button>-->
            ...
            <el-table
                ...
                <!-- 指纹数量图片请求 -->
                <el-table-column property="fingernumber" label="指纹数量" align="center" >
                    <template slot-scope="scope">             
                        {{ scope.row.fingernumber }}                      
                    </template>
                </el-table-column>
                <!-- 面容图片数量请求 -->
                <el-table-column property="facenumber" label="面容数量" align="center">
                    <template slot-scope="scope">
                        <el-button size="mini"  type="text" style="color:#606266"
                                    @click="showFace(scope.row.dwenrollnumber)"
                                    >
                                {{ scope.row.facenumber }}
                        </el-button>
                    </template>
                </el-table-column>
                <el-table-column property="enabled" label="是否启用" align="center">
                    <template slot-scope="scope">
            ...
            <el-form :model="form"
                     ...
                     label-width="100px">
                                  ...
                                  prop="id">
                                      ...
                                      placeholder="考勤编号"></el-input>
                                            </el-form-item>
                                            <el-form-item label="工号"
                                  prop="dwenrollnumber">
                                                    <el-input v-model="form.dwenrollnumber"
                                  ...
                                  prop="enabled">
                                            ...
                                            placeholder="是否启用"></el-input>
                                            </el-form-item>
                                    <el-form-item label="指纹数量"
                                  prop="fingernumber">
                                                    <el-input v-model="form.fingernumber"
                                            placeholder="指纹数量"></el-input>
                                            </el-form-item>
                                    <el-form-item label="面容数量"
                                  prop="facenumber">
                                                    <el-input v-model="form.facenumber"
                                            placeholder="面容数量"></el-input>
                                            </el-form-item>
                                    <el-form-item label="用户权限"
                                  prop="privilege">
                                                    <el-input v-model="form.privilege"
                                            placeholder="用户权限"></el-input>
                                            </el-form-item>
                            </el-form>
            <div slot="footer"
                 class="dialog-footer">
       ...
       <!--  <el-dialog title="字段选择" width="480px"
            ...
            <el-checkbox-group v-model="checkboxVal">
                                    ...
                                    <el-checkbox label="id">考勤编号</el-checkbox>
                                    <el-checkbox label="dwenrollnumber">工号</el-checkbox>
                                    <el-checkbox label="name">姓名</el-checkbox>
                                    <el-checkbox label="machinename">设备</el-checkbox>
                                    <el-checkbox label="enabled">是否启用</el-checkbox>
                                    <el-checkbox label="fingernumber">指纹数量</el-checkbox>
                                    <el-checkbox label="facenumber">面容数量</el-checkbox>
                                    <el-checkbox label="privilege">用户权限</el-checkbox>
...
<script>
    ...
    //引入请求数据方法
    import {getUser} from '@/api/getdata/index'
    //引入去除空白字符的方法
    import{removeWhite} from '@/api/validator/validator'
    //表单迭代展示的列
    const defaultFormThead = [
                    // { key: 'id', label: '考勤编号' },
                    { key: 'dwenrollnumber', label: '工号' },
                    { key: 'name', label: '姓名' },
                    { key: 'machinename', label: '设备' },
                    // { key: 'privilege',label:'用户权限'}
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                    /*校验初始化*/
                    // required：是否必须填，message：显示的错误提示
                    name: [
